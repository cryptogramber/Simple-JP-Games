...
Joshi.prototype.pickAnswer = function(answer_choice) {
	...
	if (answer_choice == self.correctPosition) {
		...
		case 0:	// answer1
			self.particleBox1.style.background = '#4CAF50';
		...
		case 1:	// answer2
			...
			self.particleBox2.style.background = '#4CAF50';
			self.particleBox3.style.color = '#E0E0E0';
			self.particleBox4.style.color = '#E0E0E0';
			break;
		case 2:	// answer3
			self.particleBox1.style.color = '#E0E0E0';
			self.particleBox2.style.color = '#E0E0E0';
			self.particleBox3.style.background = '#4CAF50';
			self.particleBox4.style.color = '#E0E0E0';
			break;
		case 3:	// answer4
			self.particleBox1.style.color = '#E0E0E0';
			self.particleBox2.style.color = '#E0E0E0';
			self.particleBox3.style.color = '#E0E0E0';
			self.particleBox4.style.background = '#4CAF50';
			break;
		default:
			break
		}
