...
TenkoInput.prototype.listen = function() {
	...
	this.bindOption("#about_this", this.hopAbout);
	this.bindOption("#help_me", this.hopHelp);
...
TenkoInput.prototype.hopAbout = function (event) {
	event.preventDefault();
	this.emit("switchPage", 1);
};

TenkoInput.prototype.hopHelp = function (event) {
	event.preventDefault();
